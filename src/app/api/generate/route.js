...
export async function POST(req) {
    try {
        ...
        const nichePrompts = {
            "Beauty & Makeup": "Extreme close-up macro portrait of one single woman with flawless makeup. The shot must look like a raw, unedited photograph taken on a professional DSLR with a macro lens. Visible skin pores, natural skin texture, and realistic eye details are essential. NO plastic or AI-smoothed skin. Natural light from a window. She wears a simple black or dark ribbed sweater. High contrast, sharp focus on the makeup details.",
            "Hair Styling": "A candid, natural-light photo of one single woman showing her hair. The aesthetic should be 'mirror selfie' or 'unedited smartphone snap'. Visible hair strands, flyaways, and real skin texture are required. Shot in a bright, real-world bedroom or bathroom with neutral white/cream walls and soft daylight. No studio lighting. She wears a casual white t-shirt. The photo must feel authentic, relatable, and completely non-artificial.",
            "Fashion & Outfits": "An influencer-style full-length mirror selfie of one single woman showing her outfit. The phone is visible in her hand. Real-world indoor setting (like a minimalist bedroom or light-filled apartment). Natural daylight, soft shadows, and authentic textures on the mirror and clothing. Shot on an iPhone 15 Pro, unedited, raw blogger style. NO smooth plastic AI skin. The photo should have a gentle, organic film-grain and feel like an authentic social media post.",
            "Nails & Beauty": "Extreme macro shot of one woman's hand and nails. The texture of the skin, cuticles, and nail polish must be hyper-realistic, as if shot on a raw DSLR. Natural soft lighting. The background should be a cozy, real-world texture like a chunky knit sleeve. Avoid perfectly symmetrical or plastic-looking 'AI hands'. Authentic, tactile, and raw aesthetic."
        };

        // Niche-specific guidance injected into the Gemini imagePrompt instruction
        const nicheImageTips = {
            "Beauty & Makeup": "CRITICAL: Must look like a RAW photo with visible pores and real skin texture. Strictly ONE person. STRONGLY FORBID plastic, smooth, or AI-generated look. Must wear a dark top. No text.",
            "Hair Styling": "CRITICAL: Must feel like an UNEDITED smartphone photo. Strictly ONE person. STRONGLY FORBID shiny, plastic, or artificial 'AI' CGI look. Bright, natural lighting. No text.",
            "Fashion & Outfits": "CRITICAL: MUST be a MIRROR SELFIE style. Strictly ONE person. Must look like a real, raw iPhone photo from a lifestyle blogger. Focus on fabric texture and natural lighting. STRONGLY FORBID plastic/smooth skin. No text.",
            "Nails & Beauty": "CRITICAL: Must show hyper-realistic human skin texture and imperfect cuticles. Strictly ONE person. Only one hand focus. STRONGLY FORBID perfectly smooth 'AI hands'. No text."
        };
