...
export async function POST(req) {
    try {
        ...
        const nichePrompts = {
            "Beauty & Makeup": "Diverse range of raw makeup photography: can be an extreme close-up macro portrait, a candid mirror selfie, or a lifestyle shot in a bright, real-world bathroom. Visible skin pores, natural textures, and realistic eye details are essential. NO plastic or AI-smoothed skin. Natural soft lighting. The subject wears a simple dark top. Realistic, unedited DSLR or smartphone look.",
            "Hair Styling": "A variety of candid, natural-light scenarios showing off one woman's hair: could be a mirror selfie, a photo taken in a minimalist bedroom, or a chic salon setting. Visible hair strands, flyaways, and real skin texture are required. Shot in a real-world environment with soft daylight. No overly artificial lighting. The photo must feel authentic, relatable, and completely non-artificial.",
            "Fashion & Outfits": "A diverse range of influencer-style photos: can be a full-length mirror selfie, a candid shot standing in an aesthetic bedroom, a street-style pose outdoors in front of a modern wall, or a side profile walking by a brick building. Phone visible in hand for mirror selfies, but also tripod-style or hand-held captures for variety. Real-world settings only. Natural daylight, soft shadows, and authentic textures. Shot on an iPhone 15 Pro, unedited, raw blogger style. NO smooth plastic AI skin. Genuine, organic film-grain quality.",
            "Nails & Beauty": "A mix of extreme macro shots and lifestyle hand poses: one hand resting on a coffee cup, or fingers displayed elegantly against a chunky knit sweater. The texture of the skin, cuticles, and nail polish must be hyper-realistic. Natural soft lighting. Avoid perfectly symmetrical or plastic-looking 'AI hands'. Authentic, tactile, and raw aesthetic."
        };

        // Niche-specific guidance injected into the Gemini imagePrompt instruction
        const nicheImageTips = {
            "Beauty & Makeup": "CRITICAL: Must look like a RAW photo with visible pores. Strictly ONE person. Variety in composition: Close-up, Mirror, or Lifestyle. STRONGLY FORBID plastic or AI-smoothed look. Dark top. No text.",
            "Hair Styling": "CRITICAL: Must feel like an UNEDITED smartphone photo. Strictly ONE person. Variety in composition: Mirror Selfie, Bedroom, or Salon. STRONGLY FORBID artificial 'AI' CGI look. Bright, natural lighting. No text.",
            "Fashion & Outfits": "CRITICAL: VARIETY in composition. Strictly ONE person. Choose between Mirror Selfie, Bedroom Lifestyle, Outdoor Street Style, or Candid Side-Profile. Must look like a real, raw, unedited iPhone photo from a fashion blogger. Focus on fabric texture and natural lighting. STRONGLY FORBID plastic/smooth skin. No text.",
            "Nails & Beauty": "CRITICAL: Must show hyper-realistic human skin texture. Strictly ONE person. Only one hand focus. Variety in background (coffee cup, sweater, etc.). STRONGLY FORBID perfectly smooth 'AI hands'. No text."
        };
