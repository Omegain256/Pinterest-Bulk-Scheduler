...
export async function POST(req) {
    try {
        ...
        const nichePrompts = {
            "Beauty & Makeup": "Diverse range of raw makeup photography: can be an extreme close-up macro portrait, a candid mirror selfie, or a lifestyle shot in a bright, real-world bathroom. FORBID COLLAGES or split-images. Focus on exactly ONE single woman. Visible skin pores, natural textures, and realistic eye details are essential. Diverse ethnic backgrounds. Natural soft lighting. Realistic, unedited DSLR or smartphone look.",
            "Hair Styling": "A variety of candid, natural-light scenarios: mirror selfie, standing in a minimalist bedroom, or a chic salon setting. FORBID COLLAGES or split-images. Strictly ONE person. Diverse ethnic backgrounds and hair textures. Visible hair strands, flyaways, and real skin texture. Shot in a real-world environment with soft daylight. The photo must feel authentic, relatable, and humanly imperfect.",
            "Fashion & Outfits": "A diverse range of influencer-style photos: can be a full-length mirror selfie, a candid standing shot in a bedroom, an outdoor street-style pose, or a side profile walking by a building. FORBID COLLAGES or split-images. Use exactly ONE unified image. Diversity across backgrounds: neutral dressing rooms, modern city streets, or aesthetic apartments. Diverse ethnic backgrounds and styles (modern, chic, athletic). Shot on an iPhone 15 Pro, unedited, raw blogger style. NO smooth plastic AI skin. Genuine, organic film-grain quality.",
            "Nails & Beauty": "A mix of extreme macro shots and lifestyle hand poses: hand resting on a coffee cup, or fingers displayed against a chunky knit sweater. FORBID COLLAGES or split-images. Texture of the skin, cuticles, and nail polish must be hyper-realistic. Natural soft lighting. Avoid perfectly symmetrical or plastic-looking 'AI hands'. Diverse ethnic backgrounds. Authentic, tactile, and raw aesthetic."
        };

        // Niche-specific guidance injected into the Gemini imagePrompt instruction
        const nicheImageTips = {
            "Beauty & Makeup": "CRITICAL: SINGLE IMAGE ONLY. NO COLLAGES or split-screens. Must look like a RAW photo with visible pores. Strictly ONE person. Variety in composition: Close-up, Mirror, or Lifestyle. STRONGLY FORBID plastic or AI-smoothed look. Diverse ethnic backgrounds. No text.",
            "Hair Styling": "CRITICAL: SINGLE IMAGE ONLY. NO COLLAGES or split-screens. Must feel like an UNEDITED smartphone photo. Strictly ONE person. Variety in composition: Mirror Selfie, Bedroom, or Salon. Diverse ethnic backgrounds/hair types. STRONGLY FORBID artificial 'AI' CGI look. No text.",
            "Fashion & Outfits": "CRITICAL: SINGLE IMAGE ONLY. NO COLLAGES or split-screens. VARIETY in composition. Choose between Mirror Selfie, Bedroom Lifestyle, Outdoor Street Style, or Candid Side-Profile. Strictly ONE person. Diverse ethnic backgrounds. Must look like a real, raw, unedited iPhone photo from a fashion blogger. Focus on fabric texture. No text.",
            "Nails & Beauty": "CRITICAL: SINGLE IMAGE ONLY. NO COLLAGES or split-screens. Must show hyper-realistic human skin texture. Strictly ONE person. Variety in background (coffee cup, sweater, etc.). Diverse ethnic backgrounds. STRONGLY FORBID smooth 'AI hands'. No text."
        };
